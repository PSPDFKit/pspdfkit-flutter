...
import 'package:nutrient_example/utils/file_utils.dart';
import 'package:nutrient_example/utils/platform_utils.dart';
import 'package:nutrient_flutter/nutrient_flutter.dart';

class PDFGenerationExampleWidget extends StatelessWidget {
  const PDFGenerationExampleWidget({Key? key}) : super(key: key);
        ...
        children: [
          ListTile(
              ...
              onTap: () => _generateFromTemplate(context)
                  .then((value) => Nutrient.present(value))),
          const Divider(),
          ListTile(
  ...
  Future<String> _generateFromHtmlString(BuildContext context) async {
    ...
    var filePath =
        await Nutrient.generatePdfFromHtmlString(html, outputFilePath);
  ...
  Future<String> _generateFromHtmlUri(BuildContext context) async {
    ...
    var filePath =
        await Nutrient.generatePdfFromHtmlUri(Uri.parse(htmlUri), outputPath);
