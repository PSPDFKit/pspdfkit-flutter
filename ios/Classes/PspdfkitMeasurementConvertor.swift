...
public class PspdfkitMeasurementConvertor :NSObject{
    ...
    */
    @objc static public func addMeasurementValueConfiguration(document: Document, configuration:NSDictionary) -> Bool{
        let measurementValueConfiguration = convertMeasurementValueConfiguration(measurementValueConfiguration: configuration);
        if (measurementValueConfiguration != nil){
    ...
    */
    ...
    static private func convertMeasurementValueConfiguration(measurementValueConfiguration:NSDictionary?) -> MeasurementValueConfiguration? {
        ...
        let scale = convertScale(measurement: measurementValueConfiguration!["scale"] as? NSDictionary)
        if (scale == nil){
            return nil
        }
