...
let DEFAULT_FILL_COLOR = "fillColor"
let DEFAULT_THICKNESS = "thickness"
let DEFAULT_ALPHA = "alpha"
let AVAILABLE_COLORS = "availableColors"
let DEFAULT_BORDER_STYLE = "borderStyle"
let DEFAULT_LINE_END = "lineEndStyle"
let DEFAULT_TEXT_SIZE = "fontSize"
let DEFAULT_FONT = "fontName"
 ...
 * It is used in the `PspdfkitPlatformView` class.
 */
    ...
    private class func extractPresets(presets: [String: Any], annotationTool: Annotation.ToolVariantID) {
        ...
        for key in presets.keys {
            ...
            case REPEAT_OVERLAY_TEXT:
                if let repeatOverlayText = presets[key] as? Bool
                {
